    ...
    printWindow.document.write(`
        ...
        <body>
            <div class="container">
                <div class="card mt-5">
                    <div class="card-body">
                        <center><h2 class="card-title text-center">Supervised Learning System to Classify Pneumonia Chronic Diseases</h2>
...
function diagnosePneumoniaLikelihood(childFever, adultFever, otherSymptoms) {
    ...
    probability = Math.min(59, probability);
